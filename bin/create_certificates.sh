...
openssl genrsa -passout pass:yd76Tmv9rKb8B8U1WuBmXTyJsAO0CzH4HAXeBHML -des3 -out private/cakey.pem 2048

echo "You will be asked to enter some information about the certificate."
openssl req -x509 -passin pass:yd76Tmv9rKb8B8U1WuBmXTyJsAO0CzH4HAXeBHML -new -nodes -key private/cakey.pem \
...
echo "Sign request"
openssl ca -passin pass:yd76Tmv9rKb8B8U1WuBmXTyJsAO0CzH4HAXeBHML -config $OPEN_SSL_CONF -in client.csr \
